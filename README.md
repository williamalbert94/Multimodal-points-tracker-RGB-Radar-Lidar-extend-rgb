...
| LiDAR–Radar, no MASG | 0.705 | 0.448 | 0.961 | 0.558 | 0.696 | 0.610 |
...
| appearance | 76.47 | 72.09 | 226 |
| density | 76.65 | 72.19 | 119 |
| geometry | 76.22 | 72.16 | 179 |
| motion | 76.15 | 71.98 | 218 |
| spatial | 76.35 | 72.34 | 139 |

Appearance and motion are the cues that carry the association: removing either
nearly doubles the identity switches (226 and 218, up from 119). Geometry comes
next (179). Density is the least useful — removing it leaves the switches
unchanged.
...
| 5 Hz | 0.73 m (37%) | 35.41 | 41.52 | 60.59 | 18 |
