...
from external.xinshuo_miscellaneous import isimsize, iscolorimage_dimension, isgrayimage_dimension, isuintimage, isfloatimage
from external.xinshuo_math import data_normalize
