"""View-of-Delft tracking dataloader (baseline).

Direct port of the RaTrack dataloader, kept so RaTrack's published setup can be
reproduced exactly. For training use `datagen_vod.TrackingDataVOD`, which adds
augmentation, clip indexing and motion features.
"""
import os
import os.path
import struct
